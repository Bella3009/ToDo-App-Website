...
task_list = psg.Listbox(values=clean_list, key="todo", enable_events=True, size=[250,100])

window = psg.Window("My To Do App", layout = [[label],[add_button, input_add], [edit_button, task_list]], size =[1000,1650])
